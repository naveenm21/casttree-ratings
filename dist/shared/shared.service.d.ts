...
export declare class SharedService {
    ...
    schemas: {};
    constructor(Sequence: Model<ISequence>, commandSourceModel: Model<ICommandSourceModel>, config: ConfigService, eventEmitter: EventEmitter2, currency_service: CurrencyService);
