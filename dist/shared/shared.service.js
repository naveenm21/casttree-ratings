...
const customlogger_service_1 = require("src/logger/customlogger.service");
...
let SharedService = class SharedService {
    constructor(logger, Sequence, commandSourceModel, config, eventEmitter, currency_service) {
        this.logger = logger;
...
exports.SharedService = SharedService = __decorate([
    ...
    __param(1, (0, mongoose_1.InjectModel)("sequence")),
    __param(2, (0, mongoose_1.InjectModel)("commandSource")),
    __metadata("design:paramtypes", [typeof (_a = typeof customlogger_service_1.CustomLogger !== "undefined" && customlogger_service_1.CustomLogger) === "function" ? _a : Object, mongoose_2.Model,
        mongoose_2.Model,
        config_1.ConfigService, typeof (_b = typeof event_emitter_1.EventEmitter2 !== "undefined" && event_emitter_1.EventEmitter2) === "function" ? _b : Object, currency_service_1.CurrencyService])
], SharedService);
var app_date_ranges;
